...
Es obliegt der Absprache zwischen Spieler und Spielleiter weitere Klassen zu kreieren oder gänzlich auf eine
zu verzichten.
...
F"ahigkeiten besitzt oder über spezielle Eigenarten verf"ugt.
\end{description}

\newpage
\section{Kämpferklassen}
\input{klassen/krieger}
\newpage
\input{klassen/paladin}

\newpage
\section{Abenteurer/Glücksritter}
\input{klassen/barde}
\newpage
\input{klassen/dieb}
\newpage
\input{klassen/streuner}

\newpage
\section{Der Waldläufer}
\input{klassen/waldlaeufer}
\newpage
\input{klassen/tiermeister}

\newpage
\section{Magiebegabte}
\input{klassen/magier}
\newpage
\input{klassen/beschwoerer}
\newpage
\input{klassen/druide}
\newpage
\input{klassen/hexe}
\newpage
\input{klassen/illusionist}
\newpage
\input{klassen/schamane}
\newpage
\input{klassen/seher}

\newpage
\section{Geweihte und Geistliche}
\input{klassen/heiler}
\newpage
\input{klassen/kleriker}
\newpage
\input{klassen/moench}